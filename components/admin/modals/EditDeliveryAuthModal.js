...
const EditDeliveryAuthModal = (props) => {
    const { visible, handleCancel, modalData } = props;
    console.log(modalData)
    const [activeTab, setActiveTab] = useState('username');

    const defaultValues = {
        mobile: activeTab === "username" ? modalData.username : null
    }
    ...
    const onModalUpdate = async (inputdata) => {
        const apiUrl = activeTab === 'username' ? "/api/deliveryuser/username" : "api/deliveryuser/password";
        try {
...
export default EditDeliveryAuthModal;
