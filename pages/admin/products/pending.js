...
import { message, Table, Pagination, Select, Tag, Input, AutoComplete, Space, Button, Tooltip } from 'antd';
const { Option } = Select;
...
const PendingProducts = ({ productData, total }) => {
    ...
    return (
        <Wrapper onActive="pendingProduct" breadcrumb={["Products", "Pending Products"]}>
            <div className="mb-5">
