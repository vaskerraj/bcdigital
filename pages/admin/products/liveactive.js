...
const LiveActiveProducts = ({ productData, total }) => {
    ...
    return (
        <Wrapper onActive="liveactiveProduct" breadcrumb={["Products", "Live & Active Products"]}>
            <div className="mb-5">
...
export default LiveActiveProducts;
