...
const Bcshop = ({ categoryAndBrand, total, products, maxPrice, categoryQuery, priceQuery, brandQuery }) => {
    ...
    return (
        <Wrapper mobileTabBar={mobileTabBarStatus}>
            <Head>
                <title>Bc shop-Buy Online Product At Best Price In Nepal | BC Digital</title>
...
export async function getServerSideProps({ query }) {
    try {
        ...
        const { data: results } = await axios.post(`${process.env.api}/api/shop/own`, {
            category,
            price,
            brand,
            page,
